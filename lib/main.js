...
function getConfiguration() {
    ...
    return {
        ...
        labelsRequire: (0, core_1.getMultilineInput)('labelsRequire'),
        labelsExclude: (0, core_1.getMultilineInput)('labelsExclude'),
        sort,
        max,
    };
}
...
function getIssues(client, config) {
    return __awaiter(this, void 0, void 0, function* () {
        let addedIssues = 0;
        const issues = yield client.paginate(client.rest.issues.list, {
...
function createOrUpdateTracker(client, config, issues) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const targetSelfIssues = yield client.paginate(client.rest.issues.list, {
